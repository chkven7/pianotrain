...
void resetglobalsparseabc(void)
{
	int r,j;
    ...
    parserinchord=0;
    ingrace=0;
    for(r=0;r<DECSIZE;r++) chorddecorators[r]=0;
    decorations[0]='.'; 
	decorations[1]='M';
	decorations[2]='L';
	decorations[3]='R'; 
	...
	decorations[7]='u';
	decorations[8]='v'; 
    for(r=0;r<SIZE_ABBREVIATIONS;r++) abbreviation[r]=0;
    voicecodes = 0;
    for(r=0;r<16;r++)
	   for(j=0;j<30;j++)
	      voicecode[r][j]=0;
    for(r=0;r<DECSIZE;r++) decorators_passback[r]=0;
    for(r=0;r<512;r++) inputline[r]=0;
    linestart=NULL; /* [SS] 2011-07-18 */
    lineposition=0; /* [SS] 2011-07-18 */
    for(r=0;r<16;r++) timesigstring[r]=0; /* [SS] 2011-08-19 links with stresspat.c */
    nokey=0;  /* K: none was encountered */
    chord_n=chord_m=0 ; /* for event_chordoff */
    fileline_number = 1;
    intune = 1;
